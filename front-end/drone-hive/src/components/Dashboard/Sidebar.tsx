        ...
        {menuItems.map(({ icon: Icon, label, path }) => (
          <div key={label} className="group">
            <li
              ...
              } p-4 flex items-center cursor-pointer group-hover:bg-basement-purple/5 transition-colors duration-75 ease-in-out delay-75 ${
                pathname === path
            ...
            >
              <Icon
                size={18}
                className="mr-3 group-hover:text-basement-indigo transition-colors duration-75 ease-in-out delay-75"
              />
              {isSidebarOpen && (
                <span className="text-right group-hover:text-basement-indigo transition-colors duration-75 ease-in-out delay-75">
                  {label}
                </span>
              )}
            </li>
